...
cd /root/young/code/mip-splatting/
# ####
meta_name="masktwostage_segformer1"
# name=default
...
command="CUDA_VISIBLE_DEVICES=1  python train-wildfeature.py -s /root/young/code/unconstrained-gs/data/brandenburg_gate -m /root/young/code/mip-splatting/output/brandenburggate --eval --load_allres --sample_more_highres --white_background --port 6323 --model_path_args_  $model_path --appearance --mask --encode_a_random --wandb --masktype segformer"
