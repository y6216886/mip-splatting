import sys
sys.path.append("/U_20240109_SZR_SMIL/yyf/young/code/mip-splatting")
from scene.hat import common
import torch
import torch.nn as nn
import torch.nn.functional as F
# from thop import profile
from scene.hat.non  import NONLocalBlock2D
from scene.hat.tools import extract_image_patches,\
    reduce_mean, reduce_sum, same_padding, reverse_patches

from scene.hat.transformer import drop_path, DropPath, PatchEmbed, Mlp,MLABlock
from scene.hat.position import PositionEmbeddingLearned, PositionEmbeddingSine
import pdb
import math
